...
from utils.feature_distillation import FD_jpeg_encode
FLAGS = flags.FLAGS

flags.DEFINE_string('model_name', 'MobileNet', 'Supported: ResNet50, VGG19, Inceptionv3 and MobileNet for ImageNet.')
